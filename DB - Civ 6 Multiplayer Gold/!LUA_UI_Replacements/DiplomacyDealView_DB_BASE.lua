...
-- DB		2021-03-12: line 1187
		if GameConfiguration.GetValue("DB_REMOVE_FOREIGN_INFO") and (not ms_OtherPlayerIsHuman and not DealIsEmpty() and not bDealValid) then		-- if (not DealIsEmpty() and not bDealValid) then
-- /DB
