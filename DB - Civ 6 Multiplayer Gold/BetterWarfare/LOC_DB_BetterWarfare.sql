...
('DB_RECON_DESC', 'en_US', '[NEWLINE][NEWLINE]Recon units are always hidden and have powerful advanced promotions (if they can live long enough to earn them).') ;
...
UPDATE LocalizedText SET Text = 'Classical Era recon unit.' WHERE Tag = 'LOC_UNIT_SKIRMISHER_DESCRIPTION' AND Language = 'en_US' ;
