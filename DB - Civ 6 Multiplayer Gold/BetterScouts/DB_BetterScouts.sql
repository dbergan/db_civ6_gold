...
;
-- Remove "Hidable" tag from Scout (otherwise it loses stealth when walking out of trees)
DELETE FROM TypeTags WHERE Type = 'UNIT_SCOUT' AND Tag = 'DB_CLASS_HIDABLE' ;
...
('DB_PROMOTION_SCOUT_PATHFINDER',	1,		1,		'PROMOTION_CLASS_RECON',	'LOC_DB_PROMOTION_PATHFINDER_NAME',	        'LOC_DB_PROMOTION_PATHFINDER_DESC'),
...
('DB_PROMOTION_SCOUT_SENTRY',		2,		1,		'PROMOTION_CLASS_RECON',	'LOC_DB_PROMOTION_SENTRY_NAME',		        'LOC_DB_PROMOTION_SENTRY_DESC'),
...
('DB_POLICY_SURVEY_UNITS_ATTACH_MODIFIER',						'MODIFIER_PLAYER_UNITS_ATTACH_MODIFIER',				'SURVEY_RECONUNITEXPERIENCE_REQUIREMENTS')
;
...
('DB_POLICY_SURVEY_UNITS_ATTACH_MODIFIER',						'ModifierId',			'DB_MOD_+1_SIGHT')
;
...
UPDATE PolicyModifiers SET ModifierId = 'DB_POLICY_SURVEY_UNITS_ATTACH_MODIFIER' WHERE PolicyType = 'POLICY_SURVEY' ;
