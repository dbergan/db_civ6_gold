...
-- Move Guerrilla to level 3
UPDATE UnitPromotions SET Level = 3, Column = 3 WHERE UnitPromotionType = 'PROMOTION_GUERRILLA' ;
-- Move Ambush to level 4
UPDATE UnitPromotions SET Level = 4, Column = 3 WHERE UnitPromotionType = 'PROMOTION_AMBUSH' ;
...
('DB_PROMOTION_RECON_EXTRA_ATTACK',	4,		1,		'PROMOTION_CLASS_RECON',	'LOC_DB_PROMOTION_DOUBLE_STRIKE_NAME',	'LOC_DB_PROMOTION_DOUBLE_STRIKE_DESCRIPTION'),
('DB_PROMOTION_RECON_ELUSIVE',		3,		1,		'PROMOTION_CLASS_RECON',	'LOC_DB_PROMOTION_ELUSIVE_NAME',		'LOC_DB_PROMOTION_ELUSIVE_DESC')
;
...
('DB_PROMOTION_RECON_ELUSIVE', 		'DB_PROMOTION_RECON_COMMANDO'),
('DB_PROMOTION_RECON_ELUSIVE', 		'DB_PROMOTION_RECON_AMPHIBIOUS'),
('PROMOTION_GUERRILLA', 			'DB_PROMOTION_RECON_COMMANDO'),
('PROMOTION_GUERRILLA', 			'DB_PROMOTION_RECON_AMPHIBIOUS'),
('DB_PROMOTION_RECON_EXTRA_ATTACK', 'DB_PROMOTION_RECON_ELUSIVE'),
