...
INSERT INTO Buildings (BuildingType, Name, Description, PrereqDistrict, Cost, MaxPlayerInstances) VALUES ('BUILDING_DB_PANTHEON', 'LOC_BUILDING_DB_PANTHEON', 'LOC_BUILDING_DB_PANTHEON_DESC', 'DISTRICT_CITY_CENTER', 250, 1) ;
...
-- Replace God King policy. Now +30% Production toward Pantheon Obelisk
...
('DB_GOD_KING_POLICY_FOR_PANTHEON_OBELISK', 'Amount', 30) ;
